			...
			<div class="container py-md-5 py-sm-4 py-3">
				<div class="row footer-info w3-agileits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
						...
						<ul>
							<li class="mb-3">
								<i class="fas fa-map-marker"></i> 143 Sebastian, USA.</li>
							<li class="mb-3">
								<i class="fas fa-mobile"></i> 333 444 3333 </li>
							<li class="mb-3">
								<i class="fas fa-phone"></i> +444 11 4444 </li>
							<li class="mb-3">
							...
							<li>
								<i class="fas fa-envelope-open"></i>
								<a href="mailto:example@mail.com"> mail 4@example.com</a>
							</li>
						</ul>
					</div>
					<!-- footer categories -->
