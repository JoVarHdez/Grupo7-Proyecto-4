...
Para hacer el usuario administrador nada mas registre un usuario regular
(en la pagina principal) y luego corre:
insert into virtualshop.administrators values (3);


Test con dusk 
composer require laravel/dusk
php artisan dusk:install
run with: php artisan dusk or php artisan dusk:fails when it has fails, run the fails
create test: php artisan dusk:make LoginTest

for run into an specific enviroment: php artisan serve --env=dusk.local
define a group: /**
                * @group search
                */
just run a group of test: php artisan dusk --group=users
------------------------------------------------------------------------
